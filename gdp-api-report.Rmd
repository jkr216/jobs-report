...
That's a nice look at GDP quarterly change since 2008, but let's go a bit deeper and visualize the 4 top level components of GDP, which are personal consumption, net exports (or imports and exports), private investment and government spending. Here is how each changed in Q2 2018.
...
bea_gdp_contributions_wrangled %>% 
  ...
  geom_col(aes(y = col_blue),
               ...
               color = "cornflowerblue",
               width = .5) +
  labs(title = paste(last(bea_gdp_contributions_wrangled$quarter), 
